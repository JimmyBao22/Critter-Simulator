...
class Infect extends Instruction {
    ...
    public Infect(String[] arguments) {
        ...
        // we do not store whether the parameter was included or not
        if (arguments.length == 0) {
...
class IfEmpty extends Instruction {
    ...
    public String toString() {
        return "ifempty " + b.toString() + " " + n.toString();
    }
}
...
class IfAlly extends Instruction {
    ...
    public String toString() {
        return "ifally " + b.toString() + " " + n.toString();
    }
...
class IfEnemy extends Instruction {
    ...
    public String toString() {
        return "ifenemy " + b.toString() + " " + n.toString();
    }
}
